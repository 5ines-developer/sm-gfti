            ...
            foreach ($object->getWorksheetIterator() as $worksheet) {
                ...
                for ($row = 2; $row <= $highestRow; $row++) {
                    ...
                    if (!empty($product)) {
                        ...
                        $marqueelink = $worksheet->getCellByColumnAndRow(10, $row)->getValue();
                        $mrp = $worksheet->getCellByColumnAndRow(11, $row)->getValue();
                        $discount = $worksheet->getCellByColumnAndRow(12, $row)->getValue();
                        $hsn = $worksheet->getCellByColumnAndRow(13, $row)->getValue();
                        $gst = $worksheet->getCellByColumnAndRow(14, $row)->getValue();
                        $otax = $worksheet->getCellByColumnAndRow(15, $row)->getValue();
                        $brandlogo = $worksheet->getCellByColumnAndRow(16, $row)->getValue();
