                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php  $cont = 0; if (!empty($enquiry)) 
                        {
                         foreach ($enquiry as $key => $value) {$cont = $cont + 1;?>
                        <tr>
                        <td><?php echo (!empty($enquiry))?$cont:'' ?></td>
                        ...
                        <td><?php echo (!empty($value->contacted_on))?date("d-M-y h:i:s", strtotime($value->contacted_on)):''; ?></td>
                        <td style="text-align:center;">
                        <a href="<?php echo base_url('view-enquiry/').$value->id?>" style="font-size: 20px;color: #257225" ><i class="fa fa-eye" aria-hidden="true"></i></a>&nbsp;&nbsp;
                        </td>
                      </tr>
                    <?php } }?>
                      </tbody>
