        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form action="<?php echo base_url() ?>update-password" method="post">
              ...
              <div>
                <input type="text" class="form-control" placeholder="Email" required="" name="remail"/>
              </div>
              <div>
                <input type="password" class="form-control" placeholder="New Password" required="" name="rpasswrd" />
              </div>
              <div>
                <input type="password" class="form-control" placeholder="Confirm Password" required="" name="rcnpassword" />
                <input type="hidden" class="form-control" value="<?php echo $id ?>" name="refrnc" />
              </div>

              <div>
                <button class="btn btn-default submit" type="submit">Update</a>
              </div>
              ...
              <div class="separator">
                ...
                <div>
                  <h1 style="margin: 10px 0 0px;"><img src="<?php echo base_url() ?>assets/img/logo.png" alt="weaves"></h1>
