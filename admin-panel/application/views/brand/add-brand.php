                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2><?php echo (!empty($brand))?'Edit':'Add' ?> Brand</h2>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <br />
                                    <form action="<?php echo base_url() ?>insert-brand" method="post"
                                        enctype="multipart/form-data" id="submitform" 
                                        class="form-horizontal form-label-left">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12">

                                                <?php if(!empty($brand['path']))
                                                {?>
                                                        ...
                                                        <div class="col-md-6 col-md-offset-3" id="edt-image">
                                                            <div class="">
                                                                <div class="image view view-first">
                                                                    ...
                                                                    src="<?php echo $this->config->item('web_url').$brand['path'] ?>"
                                                                    alt="image">
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                        for="first-name">Brand Name<span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input type="text" id="first-name" required="required"
                                                            class="form-control col-md-7 col-xs-12" name="brand"
                                                            value="<?php echo (!empty($brand['name']))?$brand['name']:''; ?>">
                                                    </div>
                                                </div>

                                                <input name="image" class="ipimg" type="hidden" value="<?php echo (!empty($brand['image']))?$brand['image']:''  ?>">
                                                <input type="hidden" value="<?php echo (!empty($brand['uniqid']))?$brand['uniqid']:random_string('alnum','20');  ?>"
                                                    name="uniq">

                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12 mb-20"
                                                        for="upload">Select Image <?php echo (empty($brand['path']))?'<span class="required">*</span>':''; ?> </label>
                                                    <div class="col-md-7 col-sm-7 col-xs-12">
                                                        <input type="file" id="upload" class="form-control col-md-7 col-xs-12"
                                                        <?php echo (empty($brand['path']))?'required="required"':''; ?>  >
                                                        <br><br>
                                                        <p><small>(For good view use 400 x 200px ratio image)</small>
                                                        </p>
