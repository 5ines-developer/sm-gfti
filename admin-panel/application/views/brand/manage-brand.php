                ...
                <div class="x_panel">
                  ...
                  <div class="x_title">
                    ...
                    <div class="banner-button">
                          ...
                          <a class="btn btn-app btn-success" href="<?php echo base_url()?>add-brand">
                      ...
                      <ul>
                        <?php 
                            ...
                            foreach ($alpharange as  $value) {
                              echo '<li> <a href="'.base_url().'manage-brand?f='.$value.'">'.$value.'</a> </li>';
                            }
                  ...
                  <div class="x_content">
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php  $cont = 0; if (!empty($brand)) 
                        {
                         foreach ($brand as $key => $value) {$cont = $cont + 1;?>
                        <tr>
                        <td><?php echo (!empty($brand))?$cont:'' ?></td>
                        ...
                        <td style="text-align:center;"><a href="<?php echo base_url('edit-brand/').$value->id?>" style="font-size: 22px;color: #2e9be0"><i class="fa fa-pencil-square" aria-hidden="true"></i></a>&nbsp;&nbsp;
                          <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url('delete-brand/').$value->id?>" style="font-size: 22px;color: #e9160fe6" ><i class="fa fa-trash" aria-hidden="true"></i></a> 
                        </td>
                      </tr>
                    <?php } }?>
                      </tbody>
