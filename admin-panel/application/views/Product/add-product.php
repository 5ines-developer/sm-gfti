                                            ...
                                            <div class="x_panel">
                                                ...
                                                <div class="x_content">
                                                    ...
                                                    <form action="<?php echo base_url() ?>insert-product" method="post"
                                                        enctype="multipart/form-data" id="productform" class="form-horizontal form-label-left">
                                                        <div class="row">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="control-group">
                                                                            ...
                                                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                                                ...
                                                                                <p style="color:red"><small>(Please press enter or comma For seperate tags)</small>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-8 col-sm-8 col-xs-12">
                                                                                <div class="brand-pricing" data-toggle="collapse" data-target="#demo">
                                                                                    <h5>Add Brand Pricing <span class="branddown"><i class="fa fa-chevron-down" aria-hidden="true"></i> </span></h5> 
                                                                                </div>
                                                                                    <div id="demo" class="collapse brand-pricing">
                                                                                        <div class="row" id="addnext">
                                                                                            ...
                                                                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                                                                <input type="number"class="form-control " name="brand_price[]" placeholder="Brand price">
                                                                                            </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12 mb-20"
                                                                                for="upload ">Product Image<span class="required">*</span></label>
                                                                                <div class="col-md-8 col-sm-8 col-xs-12">
                                                                                    <input type="file" id="upload" class="form-control col-md-7 col-xs-12" name="pimage" required="required">
                                                                                </div>
                                                                            </div>
                                                                            <input type="hidden" value="<?php echo (!empty($category['uniqid']))?$category['uniqid']:random_string('numeric','8');  ?>"name="uniq">
                                                                        ...
                                                                        <div class="col-md-4" id="edt-image">
                                                                            <div class="">
                                                                                <div class="image view view-first">
                                                                                    <img style="width: 100%; display: block;"
                                                                                    src="<?php echo base_url().'category-image/'.$category['image'] ?>"
                                                                                    alt="image">
                                                                                </div>
                                                                            </div>
                                                                        </div>
