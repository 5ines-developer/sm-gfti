							...
							<div class="slider owl-carousel-11">
								<div class="slider-item style1">
									...
									<div class="item-image">
										...
										<img src="<?php echo base_url() ?>assets/images/slider/05.png" alt="">
									</div>
									<div class="clearfix"></div>
								...
								<div class="slider-item style1">
									...
									<div class="item-image">
										<img src="<?php echo base_url() ?>assets/images/slider/01.png" alt="">
									</div>
									<div class="clearfix"></div>
								</div><!-- /.slider-item style1 -->
								<div class="slider-item style1">
									...
									<div class="item-image">
										<img src="<?php echo base_url() ?>assets/images/slider/02.png" alt="">
									</div>
									<div class="clearfix"></div>
								</div><!-- /.slider-item style1 -->
								<div class="slider-item style1">
					...
					<div class="row">
						<div class="col-md-8">
							<div class="banner-box one-half style2">
								<div class="inner-box">
									<a href="#" title="">
										<img src="<?php echo base_url() ?>assets/images/banner_boxes/banner-3.png" alt="">
									</a>
								</div><!-- /.inner-box -->
								<div class="inner-box">
									<a href="#" title="">
										<img src="<?php echo base_url() ?>assets/images/banner_boxes/banner-4.png" alt="">
									</a>
								</div><!-- /.inner-box -->
								<div class="clearfix"></div>
							</div><!-- /.box -->
							<div class="banner-box">
								<div class="inner-box">
									<a href="#" title="">
										<img src="<?php echo base_url() ?>assets/images/banner_boxes/banner-5.png" alt="">
									</a>
								</div>
							</div><!-- /.box -->
						</div><!-- /.col-md-8 -->
						<div class="col-md-4">
							<div class="counter style1">
								...
								<span class="item-special">Special Offer</span>
								<div class="counter-content">
									<div class="box-content">
										<div class="box-image owl-carousel-1">
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/banner_boxes/05.png" alt="">
											</a>
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/banner_boxes/05.png" alt="">
											</a>
                            ...
                            ?>
                                <div class="col-lg-3 col-sm-6">
                                        ...
                                        <div class="imagebox">
                                            ...
                                            <div class="box-image owl-carousel-1">
                                                <a href="#" title="">
                                                    <img src="<?php echo base_url() ?>assets/images/product/other/01.jpg" alt="">
                                                </a>
                                                <a href="#" title="">
                                                    <img src="<?php echo base_url() ?>assets/images/product/other/01.jpg" alt="">
                                                </a>
                                            ...
                                            <div class="box-content">
                                                <div class="cat-name">
                                                    <a href="#" title=""><?php echo $value->name ?></a>
                                                </div>
                                                <div class="product-name">
                                                    <a href="#" title=""><?php echo $value_prd->title ?></a>
                                                </div>
                                                <div class="price">
                                            ...
                                            <div class="box-bottom">
                                                <div class="btn-add-cart">
                                                    <a href="<?php echo base_url('cart').$value_prd->product_id ?>" title="">
							...
							<div class="owl-carousel-item">
								<div class="product-box style1">
									<div class="imagebox style1">
										<div class="box-image">
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/product/other/s01.jpg" alt="">
											</a>
										</div>
										<div class="box-content">
											<div class="cat-name">
										...
										<div class="box-bottom">
											<div class="compare-wishlist">
												<a href="#" class="compare" title="">
													<img src="<?php echo base_url() ?>assets/images/icons/compare.png" alt="">Compare
												</a>
								...
								<div class="product-box style1">
									<div class="imagebox style1">
										<div class="box-image">
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/product/other/s04.jpg" alt="">
											</a>
										</div>
										<div class="box-content">
											<div class="cat-name">
							...
							<div class="owl-carousel-item">
								<div class="product-box style1">
									<div class="imagebox style1">
										<div class="box-image">
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/product/other/s02.jpg" alt="">
											</a>
										</div>
										<div class="box-content">
											<div class="cat-name">
							...
							<div class="owl-carousel-item">
								<div class="product-box style1">
									<div class="imagebox style1">
										<div class="box-image">
											<a href="#" title="">
												<img src="<?php echo base_url() ?>assets/images/product/other/s03.jpg" alt="">
											</a>
										</div>
										<div class="box-content">
											<div class="cat-name">
						...
						<div class="col-md-12">
							<div class="owl-carousel-3">
								<div class="imagebox style4 v1">
									<div class="box-image">
										<a href="#" title="">
											<img src="<?php echo base_url() ?>assets/images/product/other/09.jpg" alt="">
										</a>
									</div><!-- /.box-image -->
									<div class="box-content">
										<div class="cat-name">
								...
								<div class="imagebox style4 v1">
									<div class="box-image">
										<a href="#" title="">
											<img src="<?php echo base_url() ?>assets/images/product/other/10.jpg" alt="">
										</a>
									</div><!-- /.box-image -->
									<div class="box-content">
										<div class="cat-name">
								...
								<div class="imagebox style4 v1">
									<div class="box-image">
										<a href="#" title="">
											<img src="<?php echo base_url() ?>assets/images/product/other/11.jpg" alt="">
										</a>
									</div><!-- /.box-image -->
									<div class="box-content">
										<div class="cat-name">
								...
								<div class="imagebox style4 v1">
									<div class="box-image">
										<a href="#" title="">
											<img src="<?php echo base_url() ?>assets/images/product/other/12.jpg" alt="">
										</a>
									</div><!-- /.box-image -->
									<div class="box-content">
										<div class="cat-name">
								...
								<div class="imagebox style4 v1">
									<div class="box-image">
										<a href="#" title="">
											<img src="<?php echo base_url() ?>assets/images/product/other/13.jpg" alt="">
										</a>
									</div><!-- /.box-image -->
									<div class="box-content">
										<div class="cat-name">
